 ...
 private void Init(int strength = 1, int dexterity = 1, int intelligence = 1,int constitution=1,bool mana=false,double exp=0,int Lvl=1)
    ...
    public Hero(string name, string myclass)
    {
      ...
      switch(myclass)
      {
        ...
        public void walka(Hero enemy,Hero hero)
        {
      ...
      while(hero.HP > 0 && enemy.HP > 0)
      {
        ...
        switch(opt)
          ...
          enemy.HP=enemy.HP-spelldamage("earth shock");
           ...
           default: Console.WriteLine("nie ma takiego spella") ;
           break;
          }
      ...
      switch (option)
    {
        case "w":
            ...
            case 3:
             ...
             int r=rand.Run(0, 1);
             switch(r){
               case 0 :Console.WriteLine("spotykasz szczura");
                 hero.walka(rat,hero);
                 break;
               case 1:Console.WriteLine("spotykasz pająka");
